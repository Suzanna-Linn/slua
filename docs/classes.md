...
- **Days (November and December):** Thursdays (focused to advanced level), Fridays (focused to beginner level), Saturdays (all levels)
- **Days (January to March):** Thursdays (focused to beginner level), Fridays (focused to advanced level), Saturdays (all levels)
